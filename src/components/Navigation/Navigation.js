  ...
  return (
    <Nav isOpen={isOpen}>
      ...
      <NavList>
        ...
        <NavListItem>
          <StyledNavLink isOpen={isOpen} to="/combobox">
            Combobox
          </StyledNavLink>
        </NavListItem>
        <NavListItem>
          <StyledNavLink isOpen={isOpen} to="/fancy-buttons">
            Fancy Buttons
          </StyledNavLink>
        </NavListItem>
        <NavListItem>
          <StyledNavLink isOpen={isOpen} to="/cool-transitions">
            Cool Transitions
          </StyledNavLink>
        </NavListItem>
        <NavListItem>
          <StyledNavLink isOpen={isOpen} to="/animated-svg">
            Animated Svg
          </StyledNavLink>
        </NavListItem>
      </NavList>
